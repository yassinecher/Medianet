...
export interface Task { id: number; programmeId?: number; programmeName?: string; phaseId?: number; phaseName?: string; assignedToUserId?: number; assigneeId?: number; assignedToEmail?: string; assignedToName?: string; assignee?: { id: number; firstName: string; lastName: string; email: string }; assignedByUserId?: number; assignedByName?: string; title: string; description?: string; expectedDeliverable?: string; dueDate?: string; priority?: TaskPriority; status: string; submissionText?: string; submissionUrl?: string; submittedAt?: string; reviewNote?: string; completedAt?: string; createdAt?: string }
